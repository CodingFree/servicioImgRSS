...
public class _GestorCategorias {

   public ArrayList <InfoServicioWeb>  lServicios = new ArrayList <InfoServicioWeb>();

   public _GestorCategorias( String sFile /* no usado en esta version */ ){
...
public static void main( String[] args )
{
	...
	_GestorCategorias gc = new _GestorCategorias( null /* debería ser el nombre de un fichero */ );
